...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> <?php echo $_SESSION['setting_name'] ?> | <a href="https://www.google.com.com" target="_blank">Flite_Booking</a></div></div>
        </footer>
